...
public class ImageLoader {
    ...
    private final RequestQueue<byte[]> mRequestQueue;
     ...
     */
    public ImageLoader(RequestQueue<byte[]> queue, ImageCache imageCache) {
        mRequestQueue = queue;
        mCache = imageCache;
    }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        // track it.
        Request<byte[],Bitmap> newRequest =
    ...
    private class BatchedImageRequest {
        ...
        private final Request<?,Bitmap> mRequest;
         ...
         */
        public BatchedImageRequest(Request<?,Bitmap> request, ImageContainer container) {
            mRequest = request;
