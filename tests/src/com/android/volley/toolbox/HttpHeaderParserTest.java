...
public class HttpHeaderParserTest extends TestCase {
    ...
    private NetworkResponse<byte[]> response;
    ...
    protected void setUp() throws Exception {
        ...
        response = new NetworkResponse<byte[]>(0, null, 0, headers, false);
    }

    public void testParseCacheHeaders_noHeaders() {
        Cache.Entry<byte[]> entry = HttpHeaderParser.parseCacheHeaders(response);
