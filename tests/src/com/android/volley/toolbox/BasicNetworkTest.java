...
public class BasicNetworkTest extends AndroidTestCase {
    ...
    public void testHeadersAndPostParams() throws Exception {
        ...
        Request<byte[],String> request = new Request<byte[],String>(Request.Method.GET, "http://foo", null) {

            @Override
            protected Response<byte[],String> parseNetworkResponse(NetworkResponse<byte[]> response) {
                return null;
            }
