...
public class ResponseDeliveryTest extends TestCase {
    ...
    private Response<byte[],byte[]> mSuccessResponse;
    ...
    protected void setUp() throws Exception {
        ...
        Cache.Entry<byte[]> cacheEntry = CacheTestUtils.makeRandomCacheEntry(data);
    ...
    public void testPostError_callsDeliverError() {
        Response<byte[],byte[]> errorResponse = Response.error(new ServerError());
